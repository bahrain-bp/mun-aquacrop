...
const translations = {
  en: {
    ...
    upload:"Upload Image",
    uploadtitle:"Analyze crop Image",
    ...
    l4:"Sitra",
    l5:"Isa Town",
    locationtxt:"Select your location in Bahrain",
    datep: "Date Planted",
  ...
  ar: {
    ...
    upload:"رفع صورة",
    uploadtitle:"تحليل صورة المحصول",
    ...
    l4:"سترة",
    l5:"مدينة عيسى",
    locationtxt:"الرجاء اختيار مدينتك في البحرين",
    datep: "تاريخ الزراعة",
    ...
    litres:"لتر",
    bktodbtn:"العودة الى شاشة التحكم",
    settings:"الاعدادات",
    mode:"وضع النهار",
    arabic:"العربية",
    so:"تسجيل الخروج"

...
const SIDEBAR_ITEMS =[
    ...
    {
        name: 'Farms', icon: MapPinHouse, color: '#6EE7B7', path:'/Farms'
    },
    {
        name: 'Crops', icon: TreePine, color: '#EC4899', path:'/Crops'
    },
    {
        name: 'Reports', icon: TrendingUp, color: '#3B82F6', path:'/Reports'
    }
]

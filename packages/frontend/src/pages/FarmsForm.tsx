            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    ...
                    >
                        ...
                        <div className="mb-4">
                            <label htmlFor="FarmName" className="block text-sm font-medium text-gray-200">Farm
                                Name</label>
                            <input
                                id="FarmName"
                        ...
                        <div className="mb-4">
                            <label htmlFor="Location"
                                   className="block text-sm font-medium text-gray-200">Location</label>
                            <input
                                id="Location"
                        ...
                        <div className="mb-4">
                            <label htmlFor="add-zone" className="block text-sm font-medium text-gray-200">Add
                                Zone</label>
                            <button
                                id="add-zone"
                                // onClick={handleAddZone} // Replace with your desired function
                                className="w-full p-3 mt-1 text-gray-800 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            >
                                Add Zone
                            </button>
                        </div>
